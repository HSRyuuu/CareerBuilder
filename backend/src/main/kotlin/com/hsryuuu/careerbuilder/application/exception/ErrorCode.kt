...
enum class ErrorCode(
    ...
    // Auth
    AUTH_DUPLICATE_USERNAME(HttpStatus.CONFLICT, "AUTH_DUPLICATE_USERNAME", "이미 존재하는 username입니다."),
    AUTH_DUPLICATE_EMAIL(HttpStatus.CONFLICT, "AUTH_DUPLICATE_EMAIL", "이미 존재하는 email입니다."),
    AUTH_DUPLICATE_NICKNAME(HttpStatus.CONFLICT, "AUTH_DUPLICATE_NICKNAME", "이미 존재하는 nickname입니다."),
